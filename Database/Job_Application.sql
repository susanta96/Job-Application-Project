...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2017 at 05:09 PM
...
--
CREATE DATABASE IF NOT EXISTS `job_application` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `job_application`;
...
--
ALTER TABLE `trans_apply`
  MODIFY `apply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;COMMIT;
